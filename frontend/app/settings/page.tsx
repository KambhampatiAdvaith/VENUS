      ...
      <main className="flex-1 p-8">
        ...
        <section className="mb-8">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 text-slate-400 text-sm space-y-3">
            <p>
              <span className="text-slate-300 font-medium">Refresh interval</span> - use a short interval (5-10 s) when monitoring live telemetry flowing through the MQTT to Kafka to backend pipeline. Increase the interval to reduce polling load during idle observation.
            </p>
            <p>
